...
/**
 * Figma source: Board UI â†’ dashboard 1 status dropdown dots (node 3731:3266).
 *
 * 12Ã—12 status indicator: a 6px solid dot centered on a tinted halo.
 * Color pairs from Figma variables:
 *   green  â†’ halo color/green/100,  dot color/green/500
 *   yellow â†’ halo color/yellow/200, dot color/yellow/500
 *   indigo â†’ halo color/indigo/100, dot color/indigo/500
